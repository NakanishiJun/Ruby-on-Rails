...
class CustomerServicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_service" do
    assert_difference('CustomerService.count') do
      post customer_services_url, params: { customer_service: { customer_id: @customer_service.customer_id, deal_date: @customer_service.deal_date, issue: @customer_service.issue, staff_id: @customer_service.staff_id } }
    end
  ...
  test "should update customer_service" do
    patch customer_service_url(@customer_service), params: { customer_service: { customer_id: @customer_service.customer_id, deal_date: @customer_service.deal_date, issue: @customer_service.issue, staff_id: @customer_service.staff_id } }
